...
const FeaturesCards = dynamic(() => import("@/components/ui/feature-3d-cards"), {
  ssr: false,
  loading: () => (
...
const ClientsSection = dynamic(() => import("@/components/ui/testimonial-card").then(mod => mod.ClientsSection), {
  ssr: false,
  loading: () => (
...
const ProjectsModal = dynamic(() => import("@/components/ui/projects-modal").then(mod => mod.ProjectsModal), { ssr: false });

const ContactModal = dynamic(() => import("@/components/ui/contact-modal").then(mod => mod.ContactModal), { ssr: false });

const BalatroRenderer = dynamic(() => import("@/components/Balatro"), {
  ssr: false,
  loading: () => <div className="w-full h-full rounded-full bg-purple-900/20 animate-pulse border border-purple-500/20" />
});

const OrbRenderer = dynamic(() => import("@/components/Orb"), {
  ssr: false,
...
const frameworkItems: FrameworkItem[] = [
  ...
  },
  {
    ...
    performance: 94,
    adoption: "Core",
    position: { top: "75%", left: "77%" } // Placed bottom to middle of docker and react
  },
  {
    name: "Supabase",
    ...
    performance: 96,
    adoption: "Primary",
    position: { top: "75%", left: "40%" } // Placed bottom to inbetween nextjs
  },
];
  ...
  return (
    ...
    >
      <div className="relative flex flex-col items-center justify-center space-y-2">
        {/* Pulsing effect from timeline prompt */}
        <div
        ...
        {/* Logo icon with popup pop-out mechanic */}
        <div className={`relative z-10 flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-full sm:rounded-full border transition-all duration-300 ${hovered
          ...
          <Image
            ...
            width={40}
            height={40}
            className={`h-8 w-8 object-contain transition-transform duration-300 ${hovered ? "scale-110 drop-shadow-[0_0_12px_rgba(255,255,255,0.8)]" : ""}`}
          />
        </div>

        {/* Name label & Details Tooltip */}
        <div className="absolute top-[130%] pointer-events-none">
          {/* Default Label */}
          <div className={`text-center text-xs tracking-wider font-semibold transition-all duration-300 ${hovered ? "opacity-0 scale-95" : "text-white/60 opacity-100 scale-100"
            }`}>
            {item.name}
          </div>

          {/* Hover Details Tooltip */}
          <div className={`absolute top-0 left-1/2 -translate-x-1/2 min-w-[220px] bg-slate-900/95 border border-purple-500/30 rounded-xl p-4 shadow-[0_10px_30px_rgba(168,85,247,0.3)] backdrop-blur-md transition-all duration-300 ${hovered ? "opacity-100 translate-y-0 scale-100" : "opacity-0 -translate-y-2 scale-95"}`}>
...
export default function HomePage() {
  ...
  // Parallax refs and transforms for the Planet spanning Hero and About
  ...
  const planetScale = useTransform(scrollYProgress, [0, 1], [0.65, 0.1]);
  const planetY = useTransform(scrollYProgress, [0, 0.8], ["115%", "150%"]);
  const planetX = useTransform(scrollYProgress, [0, 0.8], ["0%", "30%"]);
  ...
  return (
    <>
      ...
      />
    <main className="relative bg-[#0a0118] overflow-x-clip w-full max-w-[100vw]">
      {/* Navigation */}
      ...
      <div ref={heroAboutRef} className="relative w-full overflow-hidden bg-[#0a0118] z-10 pointer-events-none">
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-10 overflow-hidden [&_*]:!pointer-events-none">
          ...
          >
            <motion.div
              ...
              className="flex items-center justify-center shrink-0 aspect-square pointer-events-none relative"
              style={{
            ...
            >
              <div
                ...
                style={{ inset: '-13.5%' }}
              >
                <VisibilityGate className="w-full h-full" margin="300px">
                  <OrbRenderer
                    hue={0}
                    hoverIntensity={0.5}
                    rotateOnHover={false}
              ...
              <div className="relative w-full h-full rounded-full overflow-hidden z-10" style={{ boxShadow: "inset 0 0 120px rgba(0,0,0,0.8)" }}>
                <VisibilityGate className="w-full h-full" margin="300px">
                  <BalatroRenderer
                    spinRotation={-2}
                    spinSpeed={12}
        ...
        {/* ========= 1. HERO SECTION ========= */}
        <section id="hero" className="relative z-20 min-h-screen flex flex-col items-center justify-start text-center px-6 sm:px-12 pt-32 sm:pt-30 md:pt-40 lg:pt-32 pb-32 md:pb-56 overflow-hidden pointer-events-auto">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full border border-purple-500/30 bg-purple-500/10 px-4 py-1.5 text-sm text-purple-300 mb-12 backdrop-blur-sm z-10"
          >
          ...
          <motion.div
            ...
            className="relative z-[9999] mt-12 sm:mt-16 flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto px-8 sm:px-0 py-8 sm:py-12 pointer-events-auto"
          >
            <button onClick={() => setIsContactModalOpen(true)} className="relative z-50 px-12 py-5 bg-purple-950/60 hover:bg-white hover:text-purple-700 text-white font-semibold rounded-full transition-all duration-300 border border-purple-400/20 hover:border-white/60 shadow-[0_0_20px_rgba(168,85,247,0.15)] hover:shadow-[0_0_40px_rgba(255,255,255,0.25)] hover:backdrop-blur-md">
              Book a Call
            </button>
          </motion.div>
          ...
          <motion.div
            ...
            className="absolute bottom-12 flex flex-col items-center gap-2 text-gray-500 text-sm z-10"
          >
            <span>Scroll to explore</span>
            <motion.div
              animate={{ y: [0, 8, 0] }}
              transition={{ repeat: Infinity, duration: 1.5 }}
              className="w-5 h-8 border-2 border-gray-500/50 rounded-full flex justify-center pt-1"
            >
        ...
        {/* ========= 2. ABOUT US SECTION ========= */}
        <section id="about" aria-label="About Hyon Technologies" className="relative z-20 pt-20 pb-12 sm:pt-32 sm:pb-20 px-4 overflow-hidden pointer-events-auto">
      ...
      <div className="relative w-full z-20">
        ...
        <section id="history" className="relative py-10 sm:py-16 mt-4 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 z-10 relative">
            ...
            >
              ...
              <p className="mt-4 text-gray-400 max-w-2xl mx-auto text-sm sm:text-lg">
                Tracing the evolution of ARK Technologies from its inception to the cutting-edge Aether platform. Click nodes to explore.
              </p>
            </ScrollReveal>
        ...
        <section id="features" className="relative py-8 sm:py-12">
        ...
        {/* ========= 6. FRAMEWORKS SECTION (Radar) ========= */}
        <section id="frameworks" aria-label="Technology Stack" className="relative py-10 sm:py-16 z-20">
          <div className="max-w-7xl mx-auto px-4">
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <p className="mt-4 text-gray-400 max-w-2xl mx-auto text-sm sm:text-lg">
                Hover or tap any framework to explore our technology ecosystem in detail.
              </p>
            </motion.div>

            {/* Radar with real framework logos */}
            <div className="relative h-[350px] sm:h-[450px] w-full max-w-5xl mx-auto flex items-end justify-center overflow-visible mt-12 pb-8">
              {/* Background CSS Radar Effect, visually sliced in half */}
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 pointer-events-none w-[700px] h-[350px] sm:w-[900px] sm:h-[450px] flex items-end justify-center opacity-80 mix-blend-screen overflow-hidden">
                <div className="w-[700px] h-[700px] sm:w-[900px] sm:h-[900px] absolute translate-y-1/2 flex items-center justify-center">
                  <RadarEffect className="w-full h-full pointer-events-none" />
                </div>
              </div>
        ...
        {/* ========= 8. FOOTER CTA ========= */}
        <section className="relative py-10 sm:py-16 px-4">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="p-8 sm:p-12 md:p-16 rounded-3xl bg-black/40 backdrop-blur-xl border border-white/10 glow-purple">
              ...
              <div className="mt-10 flex justify-center">
                <button onClick={() => setIsContactModalOpen(true)} className="px-10 py-4 bg-purple-600/80 hover:bg-purple-600 text-white font-semibold rounded-full transition-all duration-300 border border-purple-500/30 hover:shadow-lg hover:shadow-purple-500/25 text-lg">
          ...
          <div className="max-w-7xl mx-auto px-4 py-12">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="text-center md:text-left">
                ...
                <nav className="flex flex-wrap gap-4 justify-center md:justify-start text-xs text-gray-400">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Instagram — Updated to newer flat logo */}
