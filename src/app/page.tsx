    ...
    <>
      ...
      >
        ...
        <div ref={heroAboutRef} className="relative w-full overflow-hidden bg-[#0a0118] z-10 pointer-events-none">
          ...
          {/* ========= 1. HERO SECTION ========= */}
          <section id="hero" className="relative z-20 min-h-[85vh] sm:min-h-[90vh] flex flex-col items-center justify-center text-center px-4 sm:px-8 md:px-12 pt-20 sm:pt-28 md:pt-32 pb-16 sm:pb-24 overflow-hidden pointer-events-auto">
